...
/// <summary>
/// 用来替代PlayerController的热更版本
/// </summary>
public class PlayerControllerReplace : MonoBehaviour
{
    Animator ani;//声明动画器
    ...
    public static PlayerControllerReplace instance;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("spike") || other.CompareTag("Fire"))
        {
            ...
            Requester.instance.PlaySoundEffect("Hit");
            if(teachLevel){
                Requester.instance.AddressablesLoadSceneSingle("TeachMenu");
                return;
            }
            else{
                PlayerDead();
    ...
    {
        playerDead = true;
        Requester.instance.GameOver(playerDead);
    }
